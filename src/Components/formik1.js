...
import DataTableBasicDemo from "./Table";
...
export const FormikFormDemo = () => {
  ...
  const changeDirection = (event) => {
    if (event.altKey === true && event.shiftKey) {
      if (rtl === "rtl") {
        setrtl("ltr");
      } else if (rtl === "ltr") {
        setrtl("rtl");
  ...
  const formik = useFormik({
    ...
    validate: (data) => {
      ...
      if (!data.gender) {
        errors.gender = "You must choose your gender";
      }
    ...
    onSubmit: (data) => {
      ...
      setResult([...result, { ...data, date: newDate }]);
      console.log(result);
      //console.log(formik.getFieldProps("gender"));
      //console.log(Object.values(formData).slice(0));
  ...
  return (
    <div className="form-demo">
        ...
        <div className="card">
          ...
          >
            ...
            <div className="group-radio">
              <div className="field-radiobutton group-radio pt-6 pr-6">
                <RadioButton
                  inputId="male"
                  name="gender"
                  value="male"
      ...
      {result.length !== 0 ? <DataTableBasicDemo products={result} /> : null}
    </div>
  );
};
